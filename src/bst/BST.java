...
******************************************************/
   ...
   private ntt<T> insert(ntt<T> p, T toInsert)
   {
      if (p == null)
         return new ntt<T>(toInsert);
...
******************************************************/
   ...
   private boolean search(ntt<T> p, T toSearch)
   {
      if (p == null)
         return false;
      else
...
******************************************************/
   ...
   private ntt<T> delete(ntt<T> p, T toDelete)
   {
   ...
   private T retrieveData(ntt<T> p)
   {
 ...
 **************************************************/
   ...
   private void preOrderHelper(ntt r)
   {
      if (r != null)
      {
         System.out.print(r+" ");
   ...
   private void inOrderHelper(ntt r)
   {
      if (r != null)
      {
 ...
 **************************************************/
   ...
   private ntt<T> cloneHelper(ntt<T> p)
   {
      if(p == null)
         return null;
      else
         return new ntt<T>(p.data, cloneHelper(p.left), cloneHelper(p.right));
   }
 ...
 **************************************************/
   ...
   private int countLeaves(ntt<T> p)
   {
      if(p == null) return 0;
      else
  ...
  //This method restores a BST given preorder and inorder traversals
   ...
   private ntt<T> restore(T[] pre, int preL, int preR, T[] in, int inL, int inR)
   {
      if(preL <= preR)
      {
         int count = 0;
   ...
   public int width(ntt<T> p, int depth)
   {
      if(p==null) return 0;
      else
      if(depth == 0) return 1;
...
******************************************************/
   ...
   {
      Stack<ntt<T>> stk = new Stack<ntt<T>>();
