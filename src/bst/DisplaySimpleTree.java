...
public class DisplaySimpleTree extends JPanel {
   BstMathComponent t;
   int xs;
   int ys;

  public DisplaySimpleTree(BstMathComponent t) {
  ...
  protected void paintComponent(Graphics g) {
    ...
    ys=20;
    g.drawString(t.ecuacion_completa,xs,ys);
    ys=ys+10;;
    int start=0;
    ...
    public void drawTree(Graphics g, ntt root) {//actually draws the tree
    int dx, dy, dx2, dy2;
